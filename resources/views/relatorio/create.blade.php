...
@section('content')
    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('salvar.relatorio') }}">
  @csrf
<br>
<div class="form-group">
    ...
    <label for="autorizacao">Você autoriza a divulgação do seu relatório para outros estudantes da FFLCH (no site da CCInt)?</label><br>
        <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="autorizacao" id="simnomecontato" value="simnomecontato" required>
            <label class="form-check-label" for="sim">Sim, com meu nome e contato</label>
        </div>
        <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="autorizacao" id="simnome" value="simnome" required>
            <label class="form-check-label" for="nao">Sim, apenas com meu nome</label>
        </div>
        <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="autorizacao" id="sim" value="sim" required>
            <label class="form-check-label" for="nao">Sim, sem meu nome e contato</label>
        </div>
        <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="autorizacao" id="nao" value="nao" required>
...
<div class="form-group segurosauderec" id="div_segurosauderec">
    ...
    <div class="form-group cursoidiomavalor" id="div_cursoidiomavalor">
        ...
        <textarea id="cursoidiomavalor" name="cursoidiomavalor" class="form-control" rows="3"></textarea>
    </div>
